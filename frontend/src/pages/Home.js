    ...
    const allMockVideos = [
      {
        id: "demo_video_1",
        title:
          "Building Modern Web Applications with React and FastAPI - Complete Tutorial",
        ...
        <div className="p-6">
          ...
          <div className="flex items-center space-x-3 p-4 overflow-x-auto scrollbar-hide mb-6">
            {[...Array(7)].map((_, i) => (
              <div
                key={i}
                className="h-8 w-20 bg-gradient-to-r from-purple-100 to-blue-100 rounded-full animate-pulse"
              ></div>
            ))}
          </div>
